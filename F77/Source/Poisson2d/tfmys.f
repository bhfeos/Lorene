...
C
C
C $Id: tfmys.f,v 1.2 2012/03/30 12:12:44 j_novak Exp $
C $Log: tfmys.f,v $
...
c
C
C $Header: /cvsroot/Lorene/F77/Source/Poisson2d/tfmys.f,v 1.2 2012/03/30 12:12:44 j_novak Exp $
C
C
	character*120 header
	data header/'$Header: /cvsroot/Lorene/F77/Source/Poisson2d/tfmys.f,v 1.2 2012/03/30 12:12:44 j_novak Exp $'/
