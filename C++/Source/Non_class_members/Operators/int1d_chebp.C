...
/*
 * $Id: int1d_chebp.C,v 1.3 2016/12/05 16:18:07 j_novak Exp $
 * $Log: int1d_chebp.C,v $
 ...
 *
 *
 * $Header: /cvsroot/Lorene/C++/Source/Non_class_members/Operators/int1d_chebp.C,v 1.3 2016/12/05 16:18:07 j_novak Exp $
 *
 */
